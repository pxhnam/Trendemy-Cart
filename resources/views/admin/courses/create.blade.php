...
@section('main')
    <div class="row">
        <div class="col-md-12 p-3 card">
            ...
            <h3 class="m-3 text-uppercase text-center">Tạo Khóa Học</h3>
            <div class="col-md-12 m-3 d-flex justify-content-center">
                <form method="POST" action="/admin/courses" class="col-md-3" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-floating mb-4">
                        <input type="text" id="lecturer" name="lecturer" placeholder=""
                            class="form-control @error('lecturer') is-invalid @enderror" value="{{ old('lecturer') }}" />
                    ...
                    <div class="form-floating mb-4">
                        <input type="text" id="fake_cost" name="fake_cost" placeholder=""
                            class="form-control @error('fake_cost') is-invalid @enderror" value="{{ old('fake_cost') }}" />
