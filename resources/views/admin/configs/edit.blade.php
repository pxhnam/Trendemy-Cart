    ...
    <div class="row">
        <div class="col-md-12 p-3 card">
            <div class="text-start m-2">
                ...
                <a href="{{ route('admin.configs.index') }}" class="d-flex align-items-center">
                    <i class='bx bx-chevron-left'></i>
                    <span>Trở về</span>
                </a>
            </div>
            <h3 class="m-3 text-uppercase text-center">Sửa Cấu Hình</h3>
            <div class="col-md-12 m-3 d-flex justify-content-center">
                <form method="POST" action="/admin/configs/{{ $config->id }}" class="col-md-3">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-floating mb-4">
                        <textarea class="form-control @error('data') is-invalid @enderror" placeholder="" id="data" name="data"
                            style="height: 150px">{{ old('data') ?? $config->data }}</textarea>
